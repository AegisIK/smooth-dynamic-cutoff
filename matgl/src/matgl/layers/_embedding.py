...
class TensorEmbedding(nn.Module):
    ...
    def forward(self, g: dgl.DGLGraph, state_attr: torch.Tensor | None = None, cutoffs=None):
        """
        ...
        C = cosine_cutoff(edge_weight, cutoffs)
        # C = post_cutoff_dist # allows us to insert polynomial envelope function
